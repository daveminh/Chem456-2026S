...
The first major assignment in the class is the biological target project, in which you will complete a small research project and give a satisfactory presentation and/or report about the scientific and business prospects of discovering a ligand for the target. Unless you have permission from me, the target should be a G protein-coupled receptor (GPCR). GPCRs are the main focus of my research, so I will have the best understanding and be able to give the best feedback about these targets. Moreover, we will have a lecture on GPCRs and some of the resources that I will point you to are focused on GPCRs. However, if you have ongoing or planned research projects focusing on another target, then I will likely allow you to work on it.

To earn a C or higher, you must complete the research project and give a satisfactory presentation. To earn a B or higher, you must also complete a satisfactory report. As mentioned in the syllabus, an unsatisfactory presentation or report may be revised with 2 tokens.

## Research

The research project includes the following steps:
* Search for and select a personal target to do further research on. The target or a close homolog must have a public crystal structure in the Protein Data Bank (https://www.rcsb.org). 
* After making sure that nobody has selected the same target, enter your name and target in the discussion on Canvas.
...
* Perform structural analysis and visualization and at least two of the following:
    ...
    * or molecular docking.

Some targets that you may find interesting are:
* CXCR4 in different oligomeric forms
...
* How suitable is the target for structure-based drug design? What structural information is available and what is the quality of this information? What is the structural or anecdotal evidence the the target is druggable? What other proteins may also be affected by a ligand that binds to the target? GPCRs often have isoforms with high sequence similarity.
...
It is helpful to address these questions in order. The presentation should be 12 minutes long, followed by 3 minutes for questions.

As a visual aid to your presentation, you should prepare a series of slides that present evidence for your answers based on your own work as well as data and figures from other sources. For example, you could perform a structural alignment between differ isoforms of your target to highlight structural differences. This may provide evidence that a ligand that can be designed to specifically bind to one isoform. (You may also present some calculations that do not directly address the questions.) Data and figures from other sources should be properly cited. Citations should be numbered/named on individual slides and an [ACS-style bibliography](https://pubs.acs.org/doi/full/10.1021/acsguide.40303) included at the end of the slide slow. The slide show should be in Apple Keynote (.key), Microsoft Powerpoint (.ppt/,pptx), or Portable Document Format (.pdf) format. Your slides should be submitted to Canvas before the first student presents. To expedite transitions between presentations, students will all present using the instructor's laptop.
...
The report is a written version of the presentation. You should address the same questions and present evidence in the text and in figures and tables. The report should be at least three pages long and saved as a document in Apple Pages (.pages), Microsoft Word (.doc/.docx), or Portable Document Format (.pdf) format. It should be submitted to Canvas.
